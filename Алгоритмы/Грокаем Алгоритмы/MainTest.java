...
class MainTest {
    ...
    void testBinarySearch_ReturnTrue_RandomArr() {
        ...
        assertTrue(binarySearch(myArr, target), "Элемент должен быть найден в массиве");
    }
    ...
    void testBinarySearch_ReturnFalse_RandomArr() {
        ...
        int target = 10;
        assertFalse(binarySearch(myArr, target), "Элемент не должен быть найден в массиве");
    }
    ...
    void testBinarySearch_ThrowException_IfArrayIsNull(){
        ...
        assertThrows(IllegalArgumentException.class, () -> binarySearch(new int[]{}, 1),
    ...
    void  testBinarySearch_ReturnTrue_IfSizeArrayIsBig(){
        ...
        assertTrue(binarySearch(myArr, 10_000_000 - 1), "Элемент должен быть найден в массиве, проверка на переполнение");
    }
}